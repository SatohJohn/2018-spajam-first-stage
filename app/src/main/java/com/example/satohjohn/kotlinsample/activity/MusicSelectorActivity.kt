...
class MusicSelectorActivity: AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val musicList = listOf(
                ...
                Music("やあ", R.raw.destiny, R.drawable.music_btn_02),
                Music("hoge", R.raw.destiny, R.drawable.music_btn_03),
                Music("hoge", R.raw.destiny, R.drawable.music_btn_04),
                Music("hoge", R.raw.destiny, R.drawable.music_btn_05),
                Music("hoge", R.raw.destiny, R.drawable.music_btn_06)
        )
